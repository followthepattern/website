...
const CV = () => {
    ...
    const learningStack = ["Rust", "C++", "Embedded Linux", "Robotics fundamentals", "Real-time systems"]
            ...
            <header className="flex mt-10 flex-col space-y-10 sm:space-y-14">
                ...
                <div className="mx-auto font-light text-lg max-w-2xl space-y-2">
                    ...
                    <p>
                        ...
                        Geoinformatics background (coordinate systems, geometry, sensor data) and a career
                    ...
                    <p>
                        ...
                        products that have to be reliable, fast and grounded in real-world constraints.
                    </p>
                </div>
            ...
            <div className="mx-auto max-w-2xl space-y-4 font-light">
                ...
                <div>
                    ...
                    <ul className={listStyle}>
                        <li>Geoinformatics BSc (BME): coordinate systems, geometry, spatial data and sensor-derived datasets</li>
                ...
                <div>
                    ...
                    <ul className={listStyle}>
                        ...
                        <li>C++: widely used across robotics and ROS, for working in existing stacks and real-time control</li>
                ...
                <p>
                    ...
                    learn publicly, and I want to do that work in robotics.
                </p>
            </div>
        </section>
    )
            ...
            <div className="grid grid-cols-12 gap-4">
                ...
                <div className={secondColumn}>
                    ...
                    <div className="font-light text-gray-700 mt-1">
                        Coursework in coordinate systems, geometry and spatial data processing.
                    </div>
                </div>
            </div>
        </section>
